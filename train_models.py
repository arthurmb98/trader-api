...
def train_models(data_frame, show_errors = True):
    ...
    model_minimo = train_fec.fit_model_fechamento_saida_atrasada(data_frame, show_errors)
    model_maximo = train_max.fit_model_maximo_saida_atrasada(data_frame, show_errors)
    model_fechamento = train_min.fit_model_minimo_saida_atrasada(data_frame, show_errors)
